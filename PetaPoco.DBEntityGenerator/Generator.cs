            ...
            foreach (var col in item.Columns.Where(x => !x.Ignore))
            {
                ...
                switch (col.PropertyType)
                {
                    ...
                    case "bool":
                        firstSection += "            <div class=\"form-group col-12\">" + Environment.NewLine;
                        firstSection += string.Format("                <label class=\"control-label\" for=\"txt_{0}\">{1}</label>{2}", propertyName, col.Comment, Environment.NewLine);
                        firstSection += string.Format("                <input class=\"form-control\" data-toggle=\"lgbSelect\" data-default-val=\"false\" />{0}", Environment.NewLine);
                        ...
                        firstSection += "                    <option value=\"true\"></option>" + Environment.NewLine;
                        firstSection += "                    <option value=\"false\"></option>" + Environment.NewLine;
                        firstSection += "                </select>" + Environment.NewLine;
                        firstSection += "            </div>" + Environment.NewLine;

                        secondSection += "                <div class=\"form-group col-sm-6\">" + Environment.NewLine;
                        secondSection += string.Format("                    <label class=\"control-label\" for=\"{0}\">{1}</label>{2}", propertyName, col.Comment, Environment.NewLine);
                        secondSection += string.Format("                    <input class=\"form-control\" data-toggle=\"lgbSelect\" />{0}", Environment.NewLine);
                        secondSection += string.Format("                    <select data-toggle=\"lgbSelect\" data-bool=\"true\" class=\"d-none\" data-default-val=\"false\" id=\"{0}\">{1}", propertyName, Environment.NewLine);
                        secondSection += "                        <option value=\"\">全部</option>" + Environment.NewLine;
                        secondSection += "                        <option value=\"true\"></option>" + Environment.NewLine;
                        secondSection += "                        <option value=\"false\"></option>" + Environment.NewLine;
